...
class ak extends x {
  public ak() { super("app_trace3", "Create table if not exists app_trace3(_id Integer primary key AUTOINCREMENT,time VARCHAR(50),content TEXT);"); }
  ...
  public long a(String paramString1, String paramString2) {
    Cursor cursor = a("content", paramString2, "time", 1);
    ArrayList arrayList = a(cursor);
    if (cursor != null)
      cursor.close(); 
    if (arrayList.size() != 0)
      return ((w)arrayList.get(0)).a(); 
...
/* Location:              E:\Android逆向\送给最好的TA\classes-dex2jar.jar!\com\baidu\mobstat\ak.class
