...
public class LuaRunnable extends Thread implements LuaGcable, LuaMetaTable, Runnable {
  ...
  public LuaRunnable(LuaContext paramLuaContext, LuaObject paramLuaObject) { this(paramLuaContext, paramLuaObject, false, null); }
  
  public LuaRunnable(LuaContext paramLuaContext, LuaObject paramLuaObject, boolean paramBoolean) { this(paramLuaContext, paramLuaObject, paramBoolean, null); }
  ...
  public LuaRunnable(LuaContext paramLuaContext, LuaObject paramLuaObject, Object[] paramArrayOfObject) { this(paramLuaContext, paramLuaObject, false, paramArrayOfObject); }
  
  public LuaRunnable(LuaContext paramLuaContext, String paramString) { this(paramLuaContext, paramString, false, null); }
  
  public LuaRunnable(LuaContext paramLuaContext, String paramString, boolean paramBoolean) { this(paramLuaContext, paramString, paramBoolean, null); }
  ...
  public LuaRunnable(LuaContext paramLuaContext, String paramString, Object[] paramArrayOfObject) { this(paramLuaContext, paramString, false, paramArrayOfObject); }
  ...
  private void a(String paramString, Object paramObject) {
    try {
      ...
      this.d.sendMsg(paramString.getMessage());
      return;
    } 
  }
...
/* Location:              E:\Android逆向\送给最好的TA\classes-dex2jar.jar!\com\androlua\LuaRunnable.class
